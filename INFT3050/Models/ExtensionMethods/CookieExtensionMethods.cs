...
namespace INFT3050.Models
{
    ...
    public static class CookieExtensions
    {
        ...
        public static void SetString(this IResponseCookies cookies, string key,
            string value, int days = 30) //cookie expires after 30 days can change later check with teammates
        {
        ...
        public static void SetInt32(this IResponseCookies cookies, string key,
            ...
            cookies.SetString(key, value.ToString(), days); //cookie expires after 30 days can change later check with teammates

        public static void SetObject<T>(this IResponseCookies cookies, string key,
            T value, int days = 30) =>
            cookies.SetString(key, JsonSerializer.Serialize(value), days); //cookie expires after 30 days can change later check with teammates
